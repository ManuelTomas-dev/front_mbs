...
function NavUserHorizontal({ user }: { user: any }) {
  ...
  return (
    <div className="ml-auto flex items-center gap-2 border-l border-border pl-2 cursor-pointer">
      <img
        src={
          "https://media.licdn.com/dms/image/v2/D4E03AQF8nQkA6jIcSw/profile-displayphoto-crop_800_800/B4EZy.O2gOIEAI-/0/1772718090751?e=1775088000&v=beta&t=Vwqb-VFe25RUiY4kl17b-CW4NUFQB6Y46166aPUXMAo"
        }
        alt={user.name}
