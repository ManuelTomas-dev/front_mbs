...
export function Module() {
  ...
  return (
    <div className="bg-white container mx-auto max-w-360 overflow-hidden">
      ...
      <div className="grid grid-cols-2 divide-x divide-slate-100 border-b border-slate-100">
        ...
        <div className="px-6 py-5 space-y-3">
          {[
            ...
            <div key={row.label} className="flex items-start gap-2">
              <span className="text-sm font-semibold text-slate-600 min-w-30">
                {row.label}
              </span>
              <span
        ...
        <div className="px-6 py-5 space-y-3 shadow-md">
          {[
            ...
            <div key={row.label} className="flex items-start gap-2">
              <span className="text-sm font-semibold text-slate-600 min-w-27.5">
                {row.label}
              </span>
              <span
                className={`text-sm ${row.bold ? "font-semibold text-slate-800" : "text-slate-600"}`}
      ...
      {/* Tab Content */}
      <div className="px-6 py-4 min-h-20 border-b border-slate-100">
