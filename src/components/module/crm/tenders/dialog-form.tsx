...
function DialogForm({ open, setOpen }: DialogFormProps) {
  return (
    <DialogContainer
      ...
      setOpen={setOpen}
      title="Tender"
      description="Create a new tender in the MBS system."
    >
      <form>
        <div className="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5">
          ...
          <Field>
            <FieldLabel>Tender Source:</FieldLabel>
            <Select>
              <SelectTrigger>
                <SelectValue placeholder="Select a tender source" />
              </SelectTrigger>
              <SelectContent>
          ...
          <Field className="mt-6">
            ...
            <Textarea placeholder="Introduce the tender details here..." />
          </Field>

          <Field className="mt-6">
            <FieldLabel>Tender Notes:</FieldLabel>
            <Textarea placeholder="Introduce the tender notes here..." />
          </Field>
        </div>

        <Field className="mt-6">
          <FieldLabel>Cost:</FieldLabel>
          <Input type="number" min={0} placeholder="Introduce the cost value" />
        </Field>
        ...
        <Field className=" grid grid-cols-2 mt-6">
